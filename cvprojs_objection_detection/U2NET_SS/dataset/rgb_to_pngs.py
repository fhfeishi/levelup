...
if __name__ == '__main__':
    ...
    rgb_png_folder = r"CV_PROJECTION\U2NET_SS\raw_data\rgbpngs\train"
    color_label_map = {(0, 0, 0): 0, (40, 200, 30): 1, (210, 80, 60): 2}
    png_folder = r"CV_PROJECTION\U2NET_SS\train_data\pngs"
    for rgb_png in tqdm(os.listdir(rgb_png_folder)):
        if rgb_png.endswith('.png'):
            rgb_png_path = os.path.join(rgb_png_folder, rgb_png)
            get_png_from_palette(rgb_png_path, color_label_map, png_folder)
